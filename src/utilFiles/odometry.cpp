    ...
    */
    ...
    if(deltaTheta == 0) {
      ...
      */
      ...
      /*
      * Otherwise, the local change in position can be found by finding the
      * chord length of the change of position of the tracking wheels
      */
...
void setStartingOdomValues() {
  switch (autonSelect) {
      case 0:
        ...
        posX = 0;
        posY = 0;
        initOrientation = simplifyRadAngle(CONST_PI / 2);
        break;
      case 1:
        // Left Quals
        posX = 38.218;
        posY = 13;
        initOrientation = simplifyRadAngle(3 * CONST_PI / 2);
        break;
      case 2:
        // Right Quals
        posX = 135;
...
const double flyAngle = CONST_PI / 4;
